...
import { MapPin, CheckCircle, ArrowRight, User, Truck, Building2, Store, CalendarDays, ShieldCheck } from "lucide-react";
export default function HowItWorks() {
    ...
    return (<div className="min-h-screen bg-gradient-to-br from-green-50 via-blue-50 to-indigo-50">
      <SEOHead title="How MealScout Works - Local Tools for Every Role" description="Choose your role, build a local presence, and use the tools built for diners, food trucks, hosts, restaurants, bars, and event coordinators." keywords="how mealscout works, food trucks, parking pass, hosts, local events, restaurant tools, affiliate links" canonicalUrl="https://mealscout.us/how-it-works" schemaData={schemaData}/>
      
      <BackHeader title="How It Works" fallbackHref="/" icon={CheckCircle} className="bg-white/95 backdrop-blur-sm border-b border-gray-200/50 shadow-sm"/>
      ...
      <div className="px-4 py-8 max-w-6xl mx-auto">
        ...
        <div className="space-y-16 mb-20">
          {steps.map(function (step, index) {
            ...
            return (<div key={index} className={"grid lg:grid-cols-2 gap-12 items-center ".concat(isEven ? 'lg:grid-flow-col-dense' : '')}>
                <div className={isEven ? 'lg:order-2' : ''}>
                  ...
                  <div className="space-y-3">
                    {step.details.map(function (detail, detailIndex) { return (<div key={detailIndex} className="flex items-center space-x-3">
                ...
                <div className={"relative ".concat(isEven ? 'lg:order-1' : '')}>
            ...
            return (<Card key={index} className="p-6 bg-white/80 backdrop-blur-sm shadow-lg hover:shadow-xl transition-shadow">
                  <CardContent className="p-0 space-y-4">
                    ...
                    <div className="space-y-2 text-sm text-gray-700">
                      {guide.details.map(function (detail, detailIndex) { return (<div key={detailIndex} className="flex items-center space-x-2">
