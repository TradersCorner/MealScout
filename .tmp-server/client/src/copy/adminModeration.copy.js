 ...
 */
export var ADMIN_MODERATION_COPY = {
    page: {
    ...
    batch: {
        ...
        selected: function (count) { return "".concat(count, " selected"); },
        ...
        cancelBatch: 'Cancel',
        processing: function (current, total) { return "Processing ".concat(current, " of ").concat(total, "..."); },
        partialSuccess: function (succeeded, failed) {
            return "".concat(succeeded, " succeeded, ").concat(failed, " failed");
        },
        allSuccess: function (count) { return "All ".concat(count, " items processed successfully"); },
