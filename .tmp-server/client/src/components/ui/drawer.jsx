...
var DrawerContent = React.forwardRef(function (_a, ref) {
    ...
    return (<DrawerPortal>
    <DrawerOverlay />
    <DrawerPrimitive.Content ref={ref} className={cn("fixed inset-x-0 bottom-0 z-50 mt-24 flex h-auto flex-col rounded-t-[10px] border border-gray-200 bg-white shadow-2xl", className)} {...props}>
