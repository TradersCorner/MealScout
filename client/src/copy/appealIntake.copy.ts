...
export const APPEAL_INTAKE_COPY = {
  page: {
...
export type AppealIntakeCopy = typeof APPEAL_INTAKE_COPY;

/**
 * Guard: Appeals are read-only.
 * No reopen, no messaging, no aggregation, no prescriptive actions.
 */
export type ReadOnlyAppealKeys =
  | 'detail.disclaimer'
  | 'page.subtitle';
