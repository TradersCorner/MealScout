...
export const MODERATION_TELEMETRY_COPY = {
  page: {
...
export type ModerationTelemetryCopy = typeof MODERATION_TELEMETRY_COPY;

/**
 * Guard: Metrics are observational, never prescriptive.
 * No performance ranking, no recommendations, no alerts.
 */
export type ObservationalMetricKeys =
  | 'metrics.queueDepth.title'
  | 'metrics.actionDistribution.title'
  | 'metrics.timeToDecision.title'
  | 'metrics.repeatReports.title';
