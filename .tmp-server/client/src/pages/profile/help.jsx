...
export default function HelpSupportPage() {
    ...
    return (<div className="max-w-md mx-auto bg-[var(--bg-app)] min-h-screen relative pb-20">
      <BackHeader title="Help & Support" subtitle="Get help when you need it" fallbackHref="/profile" icon={HelpCircle} className="bg-[hsl(var(--background))] border-b border-white/5"/>
      ...
      <div className="px-6 py-6 space-y-6">
          ...
          <Card className="border-0 shadow-md">
            <CardContent className="p-4">
              <div className="flex items-center justify-between">
                ...
                <Button variant="outline" size="sm" data-testid="button-email-support" onClick={function () {
            window.location.href = "mailto:".concat(supportEmail);
        }}>
                  Send Email
                </Button>
              </div>
        ...
        <div>
          ...
          <div className="space-y-3">
            {faqItems.map(function (item) { return (<Card key={item.id} className="border-0 shadow-md">
                <CardContent className="p-4">
          ...
          <CardContent className="p-4">
            ...
            <div className="space-y-3">
              <div className="flex items-center justify-between">
                ...
                <Button variant="ghost" size="sm" data-testid="button-user-guide" onClick={function () { return (window.location.href = "/how-it-works"); }}>
                  <ExternalLink className="w-4 h-4"/>
                </Button>
              </div>
              <div className="flex items-center justify-between">
                <span className="text-sm text-foreground">Terms of Service</span>
                <Button variant="ghost" size="sm" data-testid="button-terms" onClick={function () { return (window.location.href = "/terms-of-service"); }}>
                  <ExternalLink className="w-4 h-4"/>
                </Button>
              </div>
              <div className="flex items-center justify-between">
                <span className="text-sm text-foreground">Privacy Policy</span>
                <Button variant="ghost" size="sm" data-testid="button-privacy" onClick={function () { return (window.location.href = "/privacy-policy"); }}>
                  <ExternalLink className="w-4 h-4"/>
                </Button>
              </div>
            </div>
