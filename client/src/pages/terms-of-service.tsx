        ...
        <Card className="border-[color:var(--border-subtle)] bg-[var(--bg-card)] shadow-clean-lg">
          ...
          <CardContent className="prose prose-gray max-w-none">
            <div className="space-y-8">
              ...
              <section>
                <h2 className="text-2xl font-semibold text-[color:var(--text-primary)] mb-4">1. Acceptance of Terms</h2>
              ...
              <section>
                <h2 className="text-2xl font-semibold text-[color:var(--text-primary)] mb-4">2. Description of Service</h2>
                <p className="text-[color:var(--text-secondary)] leading-relaxed mb-4">
              ...
              <section>
                <h2 className="text-2xl font-semibold text-[color:var(--text-primary)] mb-4">3. Subscription Terms</h2>
                <p className="text-[color:var(--text-secondary)] leading-relaxed mb-4">
                ...
                <div className="bg-[var(--bg-surface)] p-4 rounded-lg mb-4">
                  <h3 className="font-semibold text-[color:var(--text-primary)] mb-2">Pricing Plans:</h3>
              ...
              <section>
                <h2 className="text-2xl font-semibold text-[color:var(--text-primary)] mb-4">4. User Conduct</h2>
                <p className="text-[color:var(--text-secondary)] leading-relaxed mb-4">
              ...
              <section>
                <h2 className="text-2xl font-semibold text-[color:var(--text-primary)] mb-4">5. Location Services</h2>
                <p className="text-[color:var(--text-secondary)] leading-relaxed mb-4">
              ...
              <section>
                <h2 className="text-2xl font-semibold text-[color:var(--text-primary)] mb-4">6. Business Verification</h2>
                <p className="text-[color:var(--text-secondary)] leading-relaxed mb-4">
              ...
              <section>
                <h2 className="text-2xl font-semibold text-[color:var(--text-primary)] mb-4">7. Payment Terms</h2>
                <p className="text-[color:var(--text-secondary)] leading-relaxed mb-4">
                ...
                <div className="bg-[var(--bg-surface)] p-4 rounded-lg mb-4">
                  <h3 className="font-semibold text-[color:var(--text-primary)] mb-2">Payment Processing:</h3>
              ...
              <section>
                <h2 className="text-2xl font-semibold text-[color:var(--text-primary)] mb-4">8. Termination</h2>
                <p className="text-[color:var(--text-secondary)] leading-relaxed mb-4">
              ...
              <section>
                <h2 className="text-2xl font-semibold text-[color:var(--text-primary)] mb-4">9. Limitation of Liability</h2>
                <p className="text-[color:var(--text-secondary)] leading-relaxed mb-4">
              ...
              <section>
                <h2 className="text-2xl font-semibold text-[color:var(--text-primary)] mb-4">10. Governing Law and Disputes</h2>
                <p className="text-[color:var(--text-secondary)] leading-relaxed mb-4">
              ...
              <section>
                <h2 className="text-2xl font-semibold text-[color:var(--text-primary)] mb-4">11. Changes to Terms</h2>
                <p className="text-[color:var(--text-secondary)] leading-relaxed mb-4">
              ...
              <section>
                <h2 className="text-2xl font-semibold text-[color:var(--text-primary)] mb-4">12. Contact Information</h2>
                <p className="text-[color:var(--text-secondary)] leading-relaxed mb-4">
