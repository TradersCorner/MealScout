...
export var COPY = {
    ...
    shareTemplates: {
        email: {
            subject: function (name) { return "Check out ".concat(name, " \u2014 killer deals on MealScout"); },
            body: function (name, url) {
        ...
        sms: {
            template: function (name, code) {
                return "Just found ".concat(name, " on MealScout with incredible deals \uD83D\uDD25 Use my link or enter code ").concat(code);
            },
        },
        facebook: {
            title: function (name) { return "Just discovered ".concat(name, " on MealScout"); },
            description: 'Amazing local food spot with killer deals 🍔',
            hashtags: '#MealScout #LocalFood #Deals',
        },
        twitter: {
            template: function (name, code) {
                return "Just found ".concat(name, " on @MealScout with incredible deals \uD83D\uDD25 Use code ").concat(code);
            },
            hashtags: '#MealScout #LocalFood #FoodDeals',
        },
        whatsapp: {
            template: function (name, url) {
                return "Hey! You gotta check out ".concat(name, " on MealScout. Here's the link: ").concat(url, " \uD83C\uDF7D\uFE0F");
            },
        },
        linkedin: {
            title: 'Discover how I\'m earning with MealScout',
            description: 'Found a way to share my favorite local restaurants AND earn recurring commissions. Here\'s how →',
        },
    },
    // ===== WITHDRAWAL / CASH OUT =====
    withdrawal: {
    ...
    commissionInfo: {
        ...
        example: {
            title: 'Example',
            scenario: 'You recommend Joe\'s Pizza. They subscribe for $25 this month. You earn 20% ($5) for signup, then 10% ($2.50) for each month they stay subscribed.',
        },
    },
    // ===== INVITE PAGE =====
    invitePage: {
        ...
        socialProof: {
            ...
            testimonial: 'I\'ve recommended my favorite restaurants and earned over $500 in the first 3 months. It\'s a win-win for restaurants and scouts like us.',
    ...
    onboarding: {
        ...
        step3: {
            ...
            description: 'If someone becomes a paid subscriber through your link, you earn 10% every month.',
        },
        step4: {
