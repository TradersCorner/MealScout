...
export function BetaDisclaimer() {
    ...
    useEffect(function () {
        var hasSeenDisclaimer = localStorage.getItem("beta-disclaimer-seen");
    ...
    return (<AlertDialog open={open} onOpenChange={handleOpenChange}>
      <AlertDialogContent data-testid="dialog-beta-disclaimer" className="max-w-lg">
        ...
        <AlertDialogFooter>
          <Button onClick={handleClose} className="w-full sm:w-auto" data-testid="button-beta-disclaimer-close">
