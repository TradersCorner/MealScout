...
var HOME_TITLE = "MealScout | Food Truck Finder & Parking Sourcing";
var HOME_DESCRIPTION = "MealScout helps food trucks find real places to park and serve — and helps customers find where food trucks are today. Discover food trucks near you or scout verified parking spots, host locations, and opportunities to operate.";
...
export default function Home() {
    ...
    return (<div className="min-h-screen bg-gradient-to-br from-gray-50 via-white to-orange-50">
      <SEOHead title={HOME_TITLE} description={HOME_DESCRIPTION} canonicalUrl={canonicalUrl} schemaData={schemaData}/>
      <Navigation />
