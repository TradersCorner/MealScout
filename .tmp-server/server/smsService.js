...
export var isSmsConfigured = function () {
...
export var sendSms = function (to, content) { return __awaiter(void 0, void 0, void 0, function () {
    var sender, error_1;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                sender = process.env.BREVO_SMS_SENDER || "MealScout";
                _a.label = 1;
            case 1:
                _a.trys.push([1, 3, , 4]);
                return [4 /*yield*/, smsApi.sendTransacSms({
                        sender: sender,
                        recipient: to,
                        content: content,
                        type: "transactional",
            ...
            case 3:
                error_1 = _a.sent();
                console.error("Brevo SMS send failed:", error_1);
                return [2 /*return*/, false];
