...
class StressTest {
    ...
    recordResult(time, success, error) {
    ...
    async testUserAuthentication() {
        ...
        this.log(`✓ Auth tests: ${result.passed} passed, ${result.failed} failed, avg ${result.avgResponseTime.toFixed(0)}ms`, 'success');
    }
    async testDealSearching() {
        ...
        result.maxResponseTime = Math.max(...times);
        this.results.push(result);
        this.log(`✓ Deal search: ${result.passed} passed, ${result.failed} failed, avg ${result.avgResponseTime.toFixed(0)}ms`, 'success');
    }
    async testRestaurantDiscovery() {
        ...
        result.maxResponseTime = Math.max(...times);
        this.results.push(result);
        this.log(`✓ Restaurant discovery: ${result.passed} passed, ${result.failed} failed, avg ${result.avgResponseTime.toFixed(0)}ms`, 'success');
    }
    async testGetRestaurantDetails() {
        ...
        result.maxResponseTime = Math.max(...times);
        this.results.push(result);
        this.log(`✓ Restaurant details: ${result.passed} passed, ${result.failed} failed, avg ${result.avgResponseTime.toFixed(0)}ms`, 'success');
    }
    async testAwardsEndpoints() {
        ...
        result.maxResponseTime = Math.max(...times);
        this.results.push(result);
        this.log(`✓ Awards system: ${result.passed} passed, ${result.failed} failed, avg ${result.avgResponseTime.toFixed(0)}ms`, 'success');
    }
    async testActionAPI() {
        ...
        this.results.push(result);
        this.log(`✓ Action API: ${result.passed} passed, ${result.failed} failed, avg ${result.avgResponseTime.toFixed(0)}ms`, 'success');
    }
    async testHealthCheck() {
        ...
        result.maxResponseTime = Math.max(...times);
        this.results.push(result);
        this.log(`✓ Health checks: ${result.passed} passed, ${result.failed} failed, avg ${result.avgResponseTime.toFixed(0)}ms`, 'success');
    }
    ...
    printSummary() {
        ...
        if (this.failedRequests === 0) {
            ...
            this.log(`✗ ${this.failedRequests} requests failed. Review errors before deployment.`, 'error');
        }
    }
    async run() {
