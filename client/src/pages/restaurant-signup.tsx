            ...
            <div className="max-w-md mx-auto" data-signup-section>
              <Card className="bg-white/80 backdrop-blur-sm shadow-xl">
                <CardContent className="p-8">
                  ...
                  {/* Google OAuth Notice */}
                  <div className="w-full bg-yellow-50 border border-yellow-200 text-yellow-800 px-6 py-3 rounded-lg mb-4">
                    <div className="flex items-center space-x-3">
                      <svg className="w-5 h-5 text-yellow-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M12 9v2m0 4h.01m-6.938 4h13.856c1.54 0 2.502-1.667 1.732-2.5L13.732 4c-.77-.833-1.964-.833-2.732 0L3.732 16.5c-.77.833.192 2.5 1.732 2.5z"/>
                      </svg>
                      <div>
                        <p className="font-medium text-sm">Google Sign-In Temporarily Unavailable</p>
                        <p className="text-xs">Please use email signup below for now</p>
                      </div>
                    </div>
                  </div>
