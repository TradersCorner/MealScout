...
export default function TermsOfService() {
    return (<div className="min-h-screen bg-gradient-to-br from-red-50 to-orange-50">
      <SEOHead title="Terms of Service - MealScout | User Agreement" description="Read MealScout's Terms of Service. Understand the rules, regulations, and user agreement for using our food deals platform. Last updated January 2025." keywords="terms of service, user agreement, terms and conditions, legal terms, platform rules" canonicalUrl="https://mealscout.us/terms-of-service"/>
      <BackHeader title="Terms of Service" fallbackHref="/" icon={FileText} rightActions={<div className="flex items-center space-x-2 text-sm text-gray-500">
