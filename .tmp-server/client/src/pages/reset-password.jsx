...
export default function ResetPassword() {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, fetch("/api/auth/reset-password/validate?token=".concat(encodeURIComponent(token)))];
                    case 1:
                        response = _a.sent();
    ...
    }), tokenValidation = _e.data, isValidatingToken = _e.isLoading, tokenError = _e.error;
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        if (!token)
                            throw new Error("No token provided");
                        return [4 /*yield*/, apiRequest("POST", "/api/auth/reset-password", {
                                token: token,
    ...
    if (!token) {
        ...
        <BackHeader title="Reset Password" fallbackHref="/forgot-password" icon={KeyRound} className="bg-white/95 backdrop-blur-sm border-b border-gray-200/50 shadow-sm"/>
    ...
    return (<div className="min-h-screen bg-gradient-to-br from-green-50 via-blue-50 to-indigo-50">
      <SEOHead title="Reset Password - MealScout | Create New Password" description="Create a new password for your MealScout account. Choose a strong, secure password to protect your account and access exclusive food deals." keywords="reset password, new password, password change, account security" canonicalUrl="https://mealscout.us/reset-password" noIndex={true}/>
      <BackHeader title="Reset Password" fallbackHref="/forgot-password" icon={KeyRound} className="bg-white/95 backdrop-blur-sm border-b border-gray-200/50 shadow-sm"/>
        ...
        <Card className="bg-white/95 backdrop-blur-sm shadow-xl border-0">
          ...
          <CardContent className="px-8 pb-8">
            ...
            return (<FormItem>
                      ...
                      <FormControl>
                        <div className="relative">
                          <Input {...field} type={showPassword ? "text" : "password"} placeholder="Enter new password" className="pr-10 py-3 border-gray-300 focus:border-green-500 focus:ring-green-500" disabled={resetPasswordMutation.isPending} data-testid="input-password"/>
                          <button type="button" onClick={function () { return setShowPassword(!showPassword); }} className="absolute right-3 top-1/2 transform -translate-y-1/2 text-gray-400 hover:text-gray-600" data-testid="button-toggle-password">
                      ...
                      {password && (<div className="mt-2">
                          <div className="flex items-center space-x-2">
                            <div className="flex-1 bg-gray-200 rounded-full h-2">
                              <div className={"h-2 rounded-full transition-all duration-300 ".concat(passwordStrength.level === 1 ? 'w-1/4 bg-red-500' :
            ...
            return (<FormItem>
                      ...
                      <FormControl>
                        <div className="relative">
                          <Input {...field} type={showConfirmPassword ? "text" : "password"} placeholder="Confirm new password" className="pr-10 py-3 border-gray-300 focus:border-green-500 focus:ring-green-500" disabled={resetPasswordMutation.isPending} data-testid="input-confirm-password"/>
                          <button type="button" onClick={function () { return setShowConfirmPassword(!showConfirmPassword); }} className="absolute right-3 top-1/2 transform -translate-y-1/2 text-gray-400 hover:text-gray-600" data-testid="button-toggle-confirm-password">
                ...
                <Button type="submit" className="w-full py-3 bg-gradient-to-r from-green-500 to-green-600 hover:from-green-600 hover:to-green-700 text-white font-semibold rounded-lg shadow-lg hover:shadow-xl transition-all duration-200" disabled={resetPasswordMutation.isPending} data-testid="button-reset-password">
                  {resetPasswordMutation.isPending ? (<div className="flex items-center space-x-2">
