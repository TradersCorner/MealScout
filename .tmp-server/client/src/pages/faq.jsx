...
import { HelpCircle, Mail, Clock, Shield, Truck, Building2, CalendarDays, Users, } from "lucide-react";
export default function FAQ() {
    ...
    return (<div className="min-h-screen bg-gradient-to-br from-blue-50 via-indigo-50 to-purple-50">
      <SEOHead title="Frequently Asked Questions - MealScout Help Center" description="Get clear answers about MealScout for diners, trucks, hosts, restaurants, bars, and event coordinators. Local tools, simple flows, full control." keywords="mealscout faq, parking pass, food trucks, hosts, local events, restaurant tools, affiliate links" canonicalUrl="https://mealscout.us/faq" schemaData={schemaData}/>
      
      <BackHeader title="Frequently Asked Questions" fallbackHref="/" icon={HelpCircle} className="bg-white/95 backdrop-blur-sm border-b border-gray-200/50 shadow-sm"/>
      ...
      <div className="px-4 py-8 max-w-4xl mx-auto">
        ...
        {/* FAQ Sections */}
        {faqs.map(function (section, sectionIndex) { return (<Card key={sectionIndex} className="mb-8 bg-white/90 backdrop-blur-sm shadow-xl">
            <CardHeader>
            ...
            <CardContent>
              <Accordion type="single" collapsible className="w-full">
                {section.questions.map(function (faq, faqIndex) { return (<AccordionItem key={faqIndex} value={"".concat(sectionIndex, "-").concat(faqIndex)}>
