        ...
        >
          ...
          >
            ...
            <div className="space-y-3">
              {/* Google Login - Main Auth */}
              <button
                onClick={() => {
                  setShowAuth(false);
                  handleGoogleLogin();
                }}
                className="w-full flex items-center justify-center space-x-3 px-4 py-3 bg-gradient-to-r from-blue-500 to-blue-600 hover:from-blue-600 hover:to-blue-700 text-white rounded-xl transition-colors"
              ...
              >
                ...
                <span className="font-medium">Continue with Replit</span>
              </button>
              
              {/* Facebook Login - Legacy Support */}
              <button
                onClick={() => {
                  setShowAuth(false);
                  handleFacebookLogin();
