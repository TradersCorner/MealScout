export var PARKING_PASS_COPY = {
    ...
    location: {
        ...
        systemNote: "Parking Pass never edits times or negotiates prices. Once inventory is wired, this list will only show hosts that match your current area and rules.",
        filters: {
            distance: "Distance",
            type: "Type",
    ...
    confirm: {
        ...
        offlineRule: "If GPS is unavailable, your spot is guaranteed for the first 4 hours. After that, rotation may occur.",
        cancellationTitle: "Cancellation",
        cancellation: "Cancellations before start return credit only. No cash refunds.",
