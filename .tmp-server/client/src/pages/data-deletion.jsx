...
export default function DataDeletion() {
    return (<div className="min-h-screen bg-gradient-to-br from-red-50 to-pink-50">
      <SEOHead title="Data Deletion - MealScout | Delete Your Account & Data" description="Learn how to request deletion of your personal data from MealScout. Step-by-step instructions for account deletion and data removal in compliance with privacy regulations." keywords="data deletion, account deletion, delete account, remove data, privacy rights" canonicalUrl="https://mealscout.us/data-deletion"/>
      <BackHeader title="Data Deletion Instructions" fallbackHref="/" icon={Trash2} rightActions={<div className="flex items-center space-x-2 text-sm text-gray-500">
              ...
              <section>
                ...
                <div className="grid md:grid-cols-2 gap-6 mb-6">
                  <div className="bg-gray-50 p-6 rounded-lg">
                    ...
                    <Button variant="outline" size="sm" className="w-full" onClick={function () { return window.location.href = 'mailto:privacy@mealscout.com?subject=Data Deletion Request'; }} data-testid="button-email-deletion">
                  ...
                  <div className="bg-gray-50 p-6 rounded-lg">
                    ...
                    <Button variant="outline" size="sm" className="w-full" onClick={function () { return window.location.href = '/contact?subject=data-deletion'; }} data-testid="button-contact-deletion">
                      Contact Form
                    </Button>
                  </div>
                </div>
