...
export default function PrivacyPolicy() {
    return (<div className="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-50">
      <SEOHead title="Privacy Policy - MealScout | Data Protection & Privacy" description="Learn how MealScout collects, uses, and protects your personal information. Our privacy policy details data handling practices, security measures, and your privacy rights." keywords="privacy policy, data protection, privacy rights, data security, personal information" canonicalUrl="https://mealscout.us/privacy-policy"/>
      <BackHeader title="Privacy Policy" fallbackHref="/" icon={Shield} rightActions={<div className="flex items-center space-x-2 text-sm text-gray-500">
            ...
            <div className="space-y-8">
              ...
              <section>
                ...
                <div className="space-y-4">
                  ...
                  <div className="bg-gray-50 p-4 rounded-lg">
                    <h3 className="font-semibold text-gray-900 mb-2">EU/UK Users (GDPR Rights):</h3>
                    <ul className="text-gray-700 space-y-1 text-sm">
                  ...
                  <div className="bg-gray-50 p-4 rounded-lg">
                    <h3 className="font-semibold text-gray-900 mb-2">California Users (CCPA/CPRA Rights):</h3>
                    <ul className="text-gray-700 space-y-1 text-sm">
