...
export default function Sitemap() {
    ...
    return (<div className="min-h-screen bg-gradient-to-br from-gray-50 via-blue-50 to-indigo-50">
      <SEOHead title="Sitemap - Complete MealScout Navigation & Page Directory" description="Browse all MealScout pages, features, and sections. Find deals, account management, restaurant partnerships, support resources, and more in our complete site directory." keywords="mealscout sitemap, site navigation, all pages, food deals directory, restaurant features, user account pages" canonicalUrl="https://mealscout.us/sitemap" schemaData={schemaData}/>
      
      <BackHeader title="Site Map" fallbackHref="/" icon={Globe} className="bg-white/95 backdrop-blur-sm border-b border-gray-200/50 shadow-sm"/>
      ...
      <div className="px-4 py-8 max-w-6xl mx-auto">
        ...
        <div className="space-y-8 mb-16">
          {siteStructure.map(function (section, sectionIndex) {
            var IconComponent = section.icon;
            return (<Card key={sectionIndex} className="bg-white/90 backdrop-blur-sm shadow-xl">
                <CardHeader>
                  <CardTitle className="text-2xl font-bold text-gray-900 flex items-center gap-3">
                    <div className={"w-8 h-8 ".concat(section.color, " rounded-xl flex items-center justify-center")}>
                ...
                <CardContent>
                  <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-4">
                    {section.pages.map(function (page, pageIndex) { return (<Link key={pageIndex} href={page.href}>
        ...
        <Card className="bg-white/90 backdrop-blur-sm shadow-xl mb-8">
          ...
          <CardContent>
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-5 gap-3">
              {popularLocations.map(function (location, index) { return (<div key={index} className="p-3 rounded-lg bg-gray-50 text-center text-sm font-medium text-gray-700">
                  {location}
                </div>); })}
            </div>
