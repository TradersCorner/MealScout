...
export var cities = pgTable("cities", {
    id: varchar("id")
        .primaryKey()
        .default(sql(templateObject_1 || (templateObject_1 = __makeTemplateObject(["gen_random_uuid()"], ["gen_random_uuid()"])))),
...
import { index, jsonb, pgTable, timestamp, varchar, text, decimal, integer, boolean, unique, } from "drizzle-orm/pg-core";
...
export var users = pgTable("users", {
    id: varchar("id")
        .primaryKey()
        .default(sql(templateObject_2 || (templateObject_2 = __makeTemplateObject(["gen_random_uuid()"], ["gen_random_uuid()"])))),
    ...
    affiliateCloserUserId: varchar("affiliate_closer_user_id").references(function () { return users.id; }, { onDelete: "set null" }),
    affiliateBookerUserId: varchar("affiliate_booker_user_id").references(function () { return users.id; }, { onDelete: "set null" }),
...
export var securityAuditLog = pgTable("security_audit_log", {
    id: varchar("id")
        .primaryKey()
        .default(sql(templateObject_3 || (templateObject_3 = __makeTemplateObject(["gen_random_uuid()"], ["gen_random_uuid()"])))),
...
export var incidents = pgTable("incidents", {
    id: varchar("id")
        .primaryKey()
        .default(sql(templateObject_4 || (templateObject_4 = __makeTemplateObject(["gen_random_uuid()"], ["gen_random_uuid()"])))),
...
export var oncallRotation = pgTable("oncall_rotation", {
    id: varchar("id")
        .primaryKey()
        .default(sql(templateObject_5 || (templateObject_5 = __makeTemplateObject(["gen_random_uuid()"], ["gen_random_uuid()"])))),
    userId: varchar("user_id")
        .notNull()
    ...
    createdAt: timestamp("created_at").defaultNow(),
}, function (table) { return [index("idx_oncall_dates").on(table.startDate, table.endDate)]; });
export var restaurants = pgTable("restaurants", {
    id: varchar("id")
        .primaryKey()
        .default(sql(templateObject_6 || (templateObject_6 = __makeTemplateObject(["gen_random_uuid()"], ["gen_random_uuid()"])))),
...
export var truckImportBatches = pgTable("truck_import_batches", {
    id: varchar("id")
        .primaryKey()
        .default(sql(templateObject_7 || (templateObject_7 = __makeTemplateObject(["gen_random_uuid()"], ["gen_random_uuid()"])))),
    source: varchar("source"),
    fileName: varchar("file_name"),
    uploadedBy: varchar("uploaded_by").references(function () { return users.id; }),
    totalRows: integer("total_rows").default(0),
    importedRows: integer("imported_rows").default(0),
    skippedRows: integer("skipped_rows").default(0),
    createdAt: timestamp("created_at").defaultNow(),
    updatedAt: timestamp("updated_at").defaultNow(),
}, function (table) { return [index("idx_truck_import_batches_created").on(table.createdAt)]; });
export var truckImportListings = pgTable("truck_import_listings", {
    id: varchar("id")
        .primaryKey()
        .default(sql(templateObject_8 || (templateObject_8 = __makeTemplateObject(["gen_random_uuid()"], ["gen_random_uuid()"])))),
    batchId: varchar("batch_id").references(function () { return truckImportBatches.id; }),
    source: varchar("source"),
...
export var truckClaimRequests = pgTable("truck_claim_requests", {
    id: varchar("id")
        .primaryKey()
        .default(sql(templateObject_9 || (templateObject_9 = __makeTemplateObject(["gen_random_uuid()"], ["gen_random_uuid()"])))),
    listingId: varchar("listing_id")
        .notNull()
        .references(function () { return truckImportListings.id; }),
    restaurantId: varchar("restaurant_id").references(function () { return restaurants.id; }),
    userId: varchar("user_id")
        .notNull()
        .references(function () { return users.id; }),
    ...
    reviewerId: varchar("reviewer_id").references(function () { return users.id; }),
...
export var deals = pgTable("deals", {
    id: varchar("id")
        .primaryKey()
        .default(sql(templateObject_10 || (templateObject_10 = __makeTemplateObject(["gen_random_uuid()"], ["gen_random_uuid()"])))),
    restaurantId: varchar("restaurant_id")
        .notNull()
        .references(function () { return restaurants.id; }),
...
export var dealClaims = pgTable("deal_claims", {
    id: varchar("id")
        .primaryKey()
        .default(sql(templateObject_11 || (templateObject_11 = __makeTemplateObject(["gen_random_uuid()"], ["gen_random_uuid()"])))),
    dealId: varchar("deal_id")
        .notNull()
        .references(function () { return deals.id; }),
    userId: varchar("user_id")
        .notNull()
        .references(function () { return users.id; }),
...
export var reviews = pgTable("reviews", {
    id: varchar("id")
        .primaryKey()
        .default(sql(templateObject_12 || (templateObject_12 = __makeTemplateObject(["gen_random_uuid()"], ["gen_random_uuid()"])))),
    restaurantId: varchar("restaurant_id")
        .notNull()
        .references(function () { return restaurants.id; }),
    userId: varchar("user_id")
...
export var verificationRequests = pgTable("verification_requests", {
    id: varchar("id")
        .primaryKey()
        .default(sql(templateObject_13 || (templateObject_13 = __makeTemplateObject(["gen_random_uuid()"], ["gen_random_uuid()"])))),
    restaurantId: varchar("restaurant_id")
        .notNull()
        .references(function () { return restaurants.id; }),
    status: varchar("status").notNull().default("pending"), // 'pending' | 'approved' | 'rejected'
...
export var dealViews = pgTable("deal_views", {
    id: varchar("id")
        .primaryKey()
        .default(sql(templateObject_14 || (templateObject_14 = __makeTemplateObject(["gen_random_uuid()"], ["gen_random_uuid()"])))),
    dealId: varchar("deal_id")
        .notNull()
        .references(function () { return deals.id; }),
    userId: varchar("user_id").references(function () { return users.id; }), // Nullable for anonymous views
...
export var restaurantFavorites = pgTable("restaurant_favorites", {
    id: varchar("id")
        .primaryKey()
        .default(sql(templateObject_15 || (templateObject_15 = __makeTemplateObject(["gen_random_uuid()"], ["gen_random_uuid()"])))),
    restaurantId: varchar("restaurant_id")
        .notNull()
        .references(function () { return restaurants.id; }),
    userId: varchar("user_id")
...
export var restaurantFollows = pgTable("restaurant_follows", {
    id: varchar("id")
        .primaryKey()
        .default(sql(templateObject_16 || (templateObject_16 = __makeTemplateObject(["gen_random_uuid()"], ["gen_random_uuid()"])))),
    restaurantId: varchar("restaurant_id")
        .notNull()
        .references(function () { return restaurants.id; }, { onDelete: "cascade" }),
    userId: varchar("user_id")
        .notNull()
    ...
    index("IDX_restaurant_follows_restaurant").on(table.restaurantId, table.followedAt.desc()),
    index("IDX_restaurant_follows_user").on(table.userId, table.followedAt.desc()),
...
export var restaurantUserRecommendations = pgTable("restaurant_user_recommendations", {
    id: varchar("id")
        .primaryKey()
        .default(sql(templateObject_17 || (templateObject_17 = __makeTemplateObject(["gen_random_uuid()"], ["gen_random_uuid()"])))),
    restaurantId: varchar("restaurant_id")
        .notNull()
        .references(function () { return restaurants.id; }, { onDelete: "cascade" }),
    userId: varchar("user_id")
    ...
    index("IDX_restaurant_user_recommendations_restaurant").on(table.restaurantId, table.recommendedAt.desc()),
    index("IDX_restaurant_user_recommendations_user").on(table.userId, table.recommendedAt.desc()),
    index("IDX_restaurant_user_recommendations_unique").on(table.restaurantId, table.userId),
]; });
// Restaurant recommendations tracking - when a restaurant appears in recommendation feeds
export var restaurantRecommendations = pgTable("restaurant_recommendations", {
    id: varchar("id")
        .primaryKey()
        .default(sql(templateObject_18 || (templateObject_18 = __makeTemplateObject(["gen_random_uuid()"], ["gen_random_uuid()"])))),
    restaurantId: varchar("restaurant_id")
        .notNull()
        .references(function () { return restaurants.id; }),
    userId: varchar("user_id").references(function () { return users.id; }), // Nullable for anonymous users
    sessionId: varchar("session_id").notNull(), // Track anonymous sessions
...
export var foodTruckSessions = pgTable("food_truck_sessions", {
    id: varchar("id")
        .primaryKey()
        .default(sql(templateObject_19 || (templateObject_19 = __makeTemplateObject(["gen_random_uuid()"], ["gen_random_uuid()"])))),
    restaurantId: varchar("restaurant_id")
        .notNull()
        .references(function () { return restaurants.id; }),
...
export var foodTruckLocations = pgTable("food_truck_locations", {
    id: varchar("id")
        .primaryKey()
        .default(sql(templateObject_20 || (templateObject_20 = __makeTemplateObject(["gen_random_uuid()"], ["gen_random_uuid()"])))),
    restaurantId: varchar("restaurant_id")
        .notNull()
        .references(function () { return restaurants.id; }),
    sessionId: varchar("session_id").references(function () { return foodTruckSessions.id; }),
...
export var userAddresses = pgTable("user_addresses", {
    id: varchar("id")
        .primaryKey()
        .default(sql(templateObject_21 || (templateObject_21 = __makeTemplateObject(["gen_random_uuid()"], ["gen_random_uuid()"])))),
    userId: varchar("user_id")
        .notNull()
        .references(function () { return users.id; }, { onDelete: "cascade" }),
...
export var passwordResetTokens = pgTable("password_reset_tokens", {
    id: varchar("id")
        .primaryKey()
        .default(sql(templateObject_22 || (templateObject_22 = __makeTemplateObject(["gen_random_uuid()"], ["gen_random_uuid()"])))),
    userId: varchar("user_id")
        .notNull()
        .references(function () { return users.id; }, { onDelete: "cascade" }),
...
export var phoneVerificationTokens = pgTable("phone_verification_tokens", {
    id: varchar("id")
        .primaryKey()
        .default(sql(templateObject_23 || (templateObject_23 = __makeTemplateObject(["gen_random_uuid()"], ["gen_random_uuid()"])))),
...
export var accountSetupTokens = pgTable("account_setup_tokens", {
    id: varchar("id")
        .primaryKey()
        .default(sql(templateObject_24 || (templateObject_24 = __makeTemplateObject(["gen_random_uuid()"], ["gen_random_uuid()"])))),
    userId: varchar("user_id")
        .notNull()
        .references(function () { return users.id; }, { onDelete: "cascade" }),
    tokenHash: text("token_hash").notNull(), // Store hashed token for security
    expiresAt: timestamp("expires_at").notNull(),
    usedAt: timestamp("used_at"), // Nullable - set when token is used
    createdByUserId: varchar("created_by_user_id").references(function () { return users.id; }, {
        onDelete: "set null",
    ...
    index("IDX_account_setup_tokens_user").on(table.userId, table.createdAt.desc()),
...
export var dealFeedback = pgTable("deal_feedback", {
    id: varchar("id")
        .primaryKey()
        .default(sql(templateObject_25 || (templateObject_25 = __makeTemplateObject(["gen_random_uuid()"], ["gen_random_uuid()"])))),
    dealId: varchar("deal_id")
        .notNull()
...
export var apiKeys = pgTable("api_keys", {
    id: varchar("id")
        .primaryKey()
        .default(sql(templateObject_26 || (templateObject_26 = __makeTemplateObject(["gen_random_uuid()"], ["gen_random_uuid()"])))),
    userId: varchar("user_id")
        .notNull()
        .references(function () { return users.id; }, { onDelete: "cascade" }),
...
export var apiKeysRelations = relations(apiKeys, function (_a) {
    var one = _a.one;
    return ({
        user: one(users, {
...
export var videoStories = pgTable("video_stories", {
    id: varchar("id")
        .primaryKey()
        .default(sql(templateObject_27 || (templateObject_27 = __makeTemplateObject(["gen_random_uuid()"], ["gen_random_uuid()"])))),
    userId: varchar("user_id")
        .notNull()
        .references(function () { return users.id; }, { onDelete: "cascade" }),
    restaurantId: varchar("restaurant_id").references(function () { return restaurants.id; }, {
    ...
    // Expiration & featured
    createdAt: timestamp("created_at").defaultNow(),
    expiresAt: timestamp("expires_at").default(sql(templateObject_28 || (templateObject_28 = __makeTemplateObject(["NOW() + INTERVAL '7 days'"], ["NOW() + INTERVAL '7 days'"])))), // 7-day expiration
...
export var storyLikes = pgTable("story_likes", {
    id: varchar("id")
        .primaryKey()
        .default(sql(templateObject_29 || (templateObject_29 = __makeTemplateObject(["gen_random_uuid()"], ["gen_random_uuid()"])))),
    storyId: varchar("story_id")
        .notNull()
        .references(function () { return videoStories.id; }, { onDelete: "cascade" }),
    userId: varchar("user_id")
        .notNull()
        .references(function () { return users.id; }, { onDelete: "cascade" }),
    createdAt: timestamp("created_at").defaultNow(),
...
// Story Comments
export var storyComments = pgTable("story_comments", {
    id: varchar("id")
        .primaryKey()
        .default(sql(templateObject_30 || (templateObject_30 = __makeTemplateObject(["gen_random_uuid()"], ["gen_random_uuid()"])))),
    storyId: varchar("story_id")
        .notNull()
        .references(function () { return videoStories.id; }, { onDelete: "cascade" }),
    userId: varchar("user_id")
        .notNull()
        .references(function () { return users.id; }, { onDelete: "cascade" }),
    parentCommentId: varchar("parent_comment_id").references(function () { return storyComments.id; }, { onDelete: "cascade" }), // for replies
...
export var storyViews = pgTable("story_views", {
    id: varchar("id")
        .primaryKey()
        .default(sql(templateObject_31 || (templateObject_31 = __makeTemplateObject(["gen_random_uuid()"], ["gen_random_uuid()"])))),
    storyId: varchar("story_id")
        .notNull()
        .references(function () { return videoStories.id; }, { onDelete: "cascade" }),
    userId: varchar("user_id").references(function () { return users.id; }, {
...
export var userReviewerLevels = pgTable("user_reviewer_levels", {
    userId: varchar("user_id")
        .primaryKey()
        .references(function () { return users.id; }, { onDelete: "cascade" }),
...
export var videoStoryReports = pgTable("video_story_reports", {
    id: varchar("id")
        .primaryKey()
        .default(sql(templateObject_32 || (templateObject_32 = __makeTemplateObject(["gen_random_uuid()"], ["gen_random_uuid()"])))),
    storyId: varchar("story_id")
        .notNull()
        .references(function () { return videoStories.id; }, { onDelete: "cascade" }),
    ...
    reviewedByAdminId: varchar("reviewed_by_admin_id").references(function () { return users.id; }),
    reviewedAt: timestamp("reviewed_at"),
...
export var feedAds = pgTable("feed_ads", {
    id: varchar("id")
        .primaryKey()
        .default(sql(templateObject_33 || (templateObject_33 = __makeTemplateObject(["gen_random_uuid()"], ["gen_random_uuid()"])))),
    title: varchar("title").notNull(),
...
export var geoAds = pgTable("geo_ads", {
    id: varchar("id")
        .primaryKey()
        .default(sql(templateObject_34 || (templateObject_34 = __makeTemplateObject(["gen_random_uuid()"], ["gen_random_uuid()"])))),
    name: varchar("name").notNull(),
    status: varchar("status").notNull().default("draft"),
    placements: jsonb("placements").notNull().default(sql(templateObject_35 || (templateObject_35 = __makeTemplateObject(["'[]'::jsonb"], ["'[]'::jsonb"])))),
    title: varchar("title").notNull(),
    body: text("body"),
...
export var geoAdEvents = pgTable("geo_ad_events", {
    id: varchar("id")
        .primaryKey()
        .default(sql(templateObject_36 || (templateObject_36 = __makeTemplateObject(["gen_random_uuid()"], ["gen_random_uuid()"])))),
    adId: varchar("ad_id")
        .notNull()
        .references(function () { return geoAds.id; }, { onDelete: "cascade" }),
    userId: varchar("user_id").references(function () { return users.id; }, {
        onDelete: "set null",
    }),
...
export var geoLocationPings = pgTable("geo_location_pings", {
    id: varchar("id")
        .primaryKey()
        .default(sql(templateObject_37 || (templateObject_37 = __makeTemplateObject(["gen_random_uuid()"], ["gen_random_uuid()"])))),
    userId: varchar("user_id").references(function () { return users.id; }, {
        onDelete: "set null",
    }),
    visitorId: varchar("visitor_id"),
...
export var storyAwards = pgTable("story_awards", {
    id: varchar("id")
        .primaryKey()
        .default(sql(templateObject_38 || (templateObject_38 = __makeTemplateObject(["gen_random_uuid()"], ["gen_random_uuid()"])))),
    storyId: varchar("story_id")
        .notNull()
        .references(function () { return videoStories.id; }, { onDelete: "cascade" }),
...
// Relations
export var videoStoriesRelations = relations(videoStories, function (_a) {
...
export var storyLikesRelations = relations(storyLikes, function (_a) {
    var one = _a.one;
    return ({
...
export var storyCommentsRelations = relations(storyComments, function (_a) {
    var one = _a.one, many = _a.many;
    return {
        story: one(videoStories, {
...
export var storyViewsRelations = relations(storyViews, function (_a) {
    var one = _a.one;
    return ({
        story: one(videoStories, {
...
export var storyAwardsRelations = relations(storyAwards, function (_a) {
    var one = _a.one;
    return ({
        story: one(videoStories, {
...
export var userReviewerLevelsRelations = relations(userReviewerLevels, function (_a) {
    var one = _a.one;
    return ({
        user: one(users, {
...
export var restaurantsRelations = relations(restaurants, function (_a) {
    var one = _a.one, many = _a.many;
    return ({
        owner: one(users, {
...
export var dealClaimsRelations = relations(dealClaims, function (_a) {
    var one = _a.one;
    return ({
        deal: one(deals, {
...
export var reviewsRelations = relations(reviews, function (_a) {
    var one = _a.one;
    return ({
        restaurant: one(restaurants, {
...
export var verificationRequestsRelations = relations(verificationRequests, function (_a) {
    var one = _a.one;
    return ({
        restaurant: one(restaurants, {
...
export var dealViewsRelations = relations(dealViews, function (_a) {
    var one = _a.one;
    return ({
        deal: one(deals, {
...
export var foodTruckSessionsRelations = relations(foodTruckSessions, function (_a) {
    var one = _a.one, many = _a.many;
    return ({
        restaurant: one(restaurants, {
...
export var foodTruckLocationsRelations = relations(foodTruckLocations, function (_a) {
    var one = _a.one;
    return ({
        restaurant: one(restaurants, {
...
export var restaurantFavoritesRelations = relations(restaurantFavorites, function (_a) {
    var one = _a.one;
    return ({
        restaurant: one(restaurants, {
...
export var restaurantFollowsRelations = relations(restaurantFollows, function (_a) {
    var one = _a.one;
    return ({
        restaurant: one(restaurants, {
...
export var restaurantUserRecommendationsRelations = relations(restaurantUserRecommendations, function (_a) {
    var one = _a.one;
    return ({
        restaurant: one(restaurants, {
...
export var restaurantRecommendationsRelations = relations(restaurantRecommendations, function (_a) {
    var one = _a.one;
    return ({
        restaurant: one(restaurants, {
...
export var userAddressesRelations = relations(userAddresses, function (_a) {
    var one = _a.one;
    return ({
        user: one(users, {
...
export var accountSetupTokensRelations = relations(accountSetupTokens, function (_a) {
    var one = _a.one;
    return ({
        user: one(users, {
...
export var dealFeedbackRelations = relations(dealFeedback, function (_a) {
    var one = _a.one;
    return ({
        deal: one(deals, {
...
export var operatingHoursTimeSlotSchema = z
    .object({
    open: z
        .string()
    ...
    var _a = slot.open.split(":").map(Number), openHours = _a[0], openMinutes = _a[1];
    var _b = slot.close.split(":").map(Number), closeHours = _b[0], closeMinutes = _b[1];
...
export var operatingHoursSchema = z.object({
    mon: z
...
export var updateRestaurantLocationSchema = z.object({
...
export var updateRestaurantOperatingHoursSchema = z.object({
    operatingHours: operatingHoursSchema,
});
// Insert schemas
export var insertRestaurantSchema = createInsertSchema(restaurants)
    .omit({
    id: true,
    createdAt: true,
    updatedAt: true,
...
export var insertDealSchema = createInsertSchema(deals)
    .omit({
    id: true,
    currentUses: true,
    createdAt: true,
...
export var insertDealClaimSchema = createInsertSchema(dealClaims).omit({
    id: true,
    claimedAt: true,
    usedAt: true,
    isUsed: true,
...
export var insertDealViewSchema = createInsertSchema(dealViews).omit({
    id: true,
    viewedAt: true,
    createdAt: true,
});
export var insertReviewSchema = createInsertSchema(reviews).omit({
    id: true,
    createdAt: true,
});
export var insertVerificationRequestSchema = createInsertSchema(verificationRequests)
    .omit({
    id: true,
    submittedAt: true,
    reviewedAt: true,
    ...
    documents: z
        ...
        .refine(function (docs) { return docs.every(function (doc) { return doc.startsWith("data:"); }); }, "Documents must be valid base64 data URLs"),
});
export var insertFoodTruckSessionSchema = createInsertSchema(foodTruckSessions).omit({
    id: true,
    startedAt: true,
    endedAt: true,
    isActive: true,
...
export var insertFoodTruckLocationSchema = createInsertSchema(foodTruckLocations)
    .omit({
    id: true,
    recordedAt: true,
    createdAt: true,
...
export var updateRestaurantMobileSettingsSchema = z.object({
    isFoodTruck: z.boolean().optional(),
    mobileOnline: z.boolean().optional(),
});
export var insertRestaurantFavoriteSchema = createInsertSchema(restaurantFavorites).omit({
    id: true,
    favoritedAt: true,
    createdAt: true,
});
export var insertRestaurantFollowSchema = createInsertSchema(restaurantFollows).omit({
    id: true,
    followedAt: true,
    createdAt: true,
});
export var insertRestaurantUserRecommendationSchema = createInsertSchema(restaurantUserRecommendations).omit({
    id: true,
    recommendedAt: true,
    createdAt: true,
});
export var insertRestaurantRecommendationSchema = createInsertSchema(restaurantRecommendations)
    .omit({
    id: true,
    showedAt: true,
    createdAt: true,
...
export var insertUserAddressSchema = createInsertSchema(userAddresses)
    .omit({
    id: true,
    createdAt: true,
    updatedAt: true,
...
export var insertPasswordResetTokenSchema = createInsertSchema(passwordResetTokens)
    .omit({
    id: true,
    usedAt: true,
    createdAt: true,
    ...
    expiresAt: z
        .date()
        .refine(function (date) { return date > new Date(); }, "Expiry date must be in the future"),
...
export var insertPhoneVerificationTokenSchema = createInsertSchema(phoneVerificationTokens)
    .omit({
    id: true,
    usedAt: true,
    createdAt: true,
...
export var insertAccountSetupTokenSchema = createInsertSchema(accountSetupTokens)
    .omit({
    id: true,
    usedAt: true,
    createdAt: true,
...
export var insertDealFeedbackSchema = createInsertSchema(dealFeedback)
    .omit({
    id: true,
    createdAt: true,
})
...
export var insertVideoStorySchema = createInsertSchema(videoStories)
    .omit({
    id: true,
    viewCount: true,
    likeCount: true,
...
export var insertStoryLikeSchema = createInsertSchema(storyLikes).omit({
    id: true,
    createdAt: true,
});
export var insertStoryCommentSchema = createInsertSchema(storyComments)
    .omit({
    id: true,
    createdAt: true,
    updatedAt: true,
...
export var insertStoryViewSchema = createInsertSchema(storyViews)
    .omit({
    id: true,
    viewedAt: true,
})
...
export var insertStoryAwardSchema = createInsertSchema(storyAwards)
    .omit({
    id: true,
    awardedAt: true,
})
...
export var supportTickets = pgTable("support_tickets", {
    id: varchar("id")
        .primaryKey()
        .default(sql(templateObject_39 || (templateObject_39 = __makeTemplateObject(["gen_random_uuid()"], ["gen_random_uuid()"])))),
    userId: varchar("user_id")
        .notNull()
        .references(function () { return users.id; }, { onDelete: "cascade" }),
    ...
    adminNotes: text("admin_notes"),
    assignedToAdminId: varchar("assigned_to_admin_id").references(function () { return users.id; }, { onDelete: "set null" }),
    createdAt: timestamp("created_at")
        .notNull()
        .default(sql(templateObject_40 || (templateObject_40 = __makeTemplateObject(["now()"], ["now()"])))),
    updatedAt: timestamp("updated_at")
        .notNull()
        .default(sql(templateObject_41 || (templateObject_41 = __makeTemplateObject(["now()"], ["now()"])))),
    resolvedAt: timestamp("resolved_at"),
    resolvedByAdminId: varchar("resolved_by_admin_id").references(function () { return users.id; }, { onDelete: "set null" }),
}, function (table) { return [
...
export var moderationEvents = pgTable("moderation_events", {
    id: varchar("id")
        .primaryKey()
        .default(sql(templateObject_42 || (templateObject_42 = __makeTemplateObject(["gen_random_uuid()"], ["gen_random_uuid()"])))),
    ...
    reportedUserId: varchar("reported_user_id").references(function () { return users.id; }, {
        onDelete: "cascade",
    }),
    ...
    reporterUserId: varchar("reporter_user_id").references(function () { return users.id; }, {
        onDelete: "set null",
    }),
    ...
    reviewedByAdminId: varchar("reviewed_by_admin_id").references(function () { return users.id; }, { onDelete: "set null" }),
    createdAt: timestamp("created_at")
        .notNull()
        .default(sql(templateObject_43 || (templateObject_43 = __makeTemplateObject(["now()"], ["now()"])))),
    reviewedAt: timestamp("reviewed_at"),
}, function (table) { return [
...
export var affiliateLinks = pgTable("affiliate_links", {
    id: varchar("id")
        .primaryKey()
        .default(sql(templateObject_44 || (templateObject_44 = __makeTemplateObject(["gen_random_uuid()"], ["gen_random_uuid()"])))),
...
export var affiliateClicks = pgTable("affiliate_clicks", {
    id: varchar("id")
        .primaryKey()
        .default(sql(templateObject_45 || (templateObject_45 = __makeTemplateObject(["gen_random_uuid()"], ["gen_random_uuid()"])))),
    affiliateLinkId: varchar("affiliate_link_id")
        .notNull()
        .references(function () { return affiliateLinks.id; }, { onDelete: "cascade" }),
    ...
    restaurantSignupId: varchar("restaurant_signup_id").references(function () { return users.id; }, { onDelete: "set null" }),
...
export var affiliateCommissions = pgTable("affiliate_commissions", {
    id: varchar("id")
        .primaryKey()
        .default(sql(templateObject_46 || (templateObject_46 = __makeTemplateObject(["gen_random_uuid()"], ["gen_random_uuid()"])))),
    affiliateUserId: varchar("affiliate_user_id")
        .notNull()
        .references(function () { return users.id; }, { onDelete: "cascade" }),
    restaurantUserId: varchar("restaurant_user_id")
        .notNull()
        .references(function () { return users.id; }, { onDelete: "cascade" }),
    affiliateLinkId: varchar("affiliate_link_id").references(function () { return affiliateLinks.id; }, { onDelete: "set null" }),
...
export var affiliateWallet = pgTable("affiliate_wallet", {
    id: varchar("id")
        .primaryKey()
        .default(sql(templateObject_47 || (templateObject_47 = __makeTemplateObject(["gen_random_uuid()"], ["gen_random_uuid()"])))),
    userId: varchar("user_id")
        .notNull()
        .unique()
        .references(function () { return users.id; }, { onDelete: "cascade" }),
    ...
    updatedAt: timestamp("updated_at").defaultNow(),
}, function (table) { return [index("idx_wallet_user").on(table.userId)]; });
// Withdrawal requests / Cash out requests
export var affiliateWithdrawals = pgTable("affiliate_withdrawals", {
    id: varchar("id")
        .primaryKey()
        .default(sql(templateObject_48 || (templateObject_48 = __makeTemplateObject(["gen_random_uuid()"], ["gen_random_uuid()"])))),
    userId: varchar("user_id")
        .notNull()
        .references(function () { return users.id; }, { onDelete: "cascade" }),
    ...
    creditLedgerId: varchar("credit_ledger_id").references(function () { return creditLedger.id; }, { onDelete: "set null" }),
    approvedAt: timestamp("approved_at"),
    approvedBy: varchar("approved_by").references(function () { return users.id; }, {
        onDelete: "set null",
    }),
    paidAt: timestamp("paid_at"),
...
export var locationRequests = pgTable("location_requests", {
    id: varchar("id")
        .primaryKey()
        .default(sql(templateObject_49 || (templateObject_49 = __makeTemplateObject(["gen_random_uuid()"], ["gen_random_uuid()"])))),
...
export var truckInterests = pgTable("truck_interests", {
    id: varchar("id")
        .primaryKey()
        .default(sql(templateObject_50 || (templateObject_50 = __makeTemplateObject(["gen_random_uuid()"], ["gen_random_uuid()"])))),
    locationRequestId: varchar("location_request_id")
        .notNull()
        .references(function () { return locationRequests.id; }, { onDelete: "cascade" }),
    restaurantId: varchar("restaurant_id")
        .notNull()
        .references(function () { return restaurants.id; }, { onDelete: "cascade" }),
...
export var hosts = pgTable("hosts", {
    id: varchar("id")
        .primaryKey()
        .default(sql(templateObject_51 || (templateObject_51 = __makeTemplateObject(["gen_random_uuid()"], ["gen_random_uuid()"])))),
    userId: varchar("user_id")
        .notNull()
        .references(function () { return users.id; }, { onDelete: "cascade" }),
    businessName: varchar("business_name").notNull(),
...
export var affiliateShareEvents = pgTable("affiliate_share_events", {
    id: varchar("id")
        .primaryKey()
        .default(sql(templateObject_52 || (templateObject_52 = __makeTemplateObject(["gen_random_uuid()"], ["gen_random_uuid()"])))),
    affiliateUserId: varchar("affiliate_user_id")
        .notNull()
        .references(function () { return users.id; }, { onDelete: "cascade" }),
...
export var emailVerificationTokens = pgTable("email_verification_tokens", {
    id: varchar("id")
        .primaryKey()
        .default(sql(templateObject_53 || (templateObject_53 = __makeTemplateObject(["gen_random_uuid()"], ["gen_random_uuid()"])))),
    userId: varchar("user_id")
        .notNull()
        .references(function () { return users.id; }, { onDelete: "cascade" }),
    tokenHash: text("token_hash").notNull(),
...
export var parkingPassBlackoutDates = pgTable("parking_pass_blackout_dates", {
    id: varchar("id")
        .primaryKey()
        .default(sql(templateObject_54 || (templateObject_54 = __makeTemplateObject(["gen_random_uuid()"], ["gen_random_uuid()"])))),
    seriesId: varchar("series_id")
        .notNull()
        .references(function () { return eventSeries.id; }, { onDelete: "cascade" }),
...
export var eventSeries = pgTable("event_series", {
    id: varchar("id")
        .primaryKey()
        .default(sql(templateObject_55 || (templateObject_55 = __makeTemplateObject(["gen_random_uuid()"], ["gen_random_uuid()"])))),
    hostId: varchar("host_id")
        .notNull()
        .references(function () { return hosts.id; }, { onDelete: "cascade" }),
...
export var events = pgTable("events", {
    id: varchar("id")
        .primaryKey()
        .default(sql(templateObject_56 || (templateObject_56 = __makeTemplateObject(["gen_random_uuid()"], ["gen_random_uuid()"])))),
    hostId: varchar("host_id")
        .notNull()
        .references(function () { return hosts.id; }, { onDelete: "cascade" }),
    seriesId: varchar("series_id").references(function () { return eventSeries.id; }, {
        onDelete: "set null",
    ...
    bookedRestaurantId: varchar("booked_restaurant_id").references(function () { return restaurants.id; }, { onDelete: "set null" }),
    // Capacity Guard v2.2
...
export var eventInterests = pgTable("event_interests", {
    id: varchar("id")
        .primaryKey()
        .default(sql(templateObject_57 || (templateObject_57 = __makeTemplateObject(["gen_random_uuid()"], ["gen_random_uuid()"])))),
    eventId: varchar("event_id")
        .notNull()
        .references(function () { return events.id; }, { onDelete: "cascade" }),
...
export var hostReviews = pgTable("host_reviews", {
    id: varchar("id")
        .primaryKey()
        .default(sql(templateObject_58 || (templateObject_58 = __makeTemplateObject(["gen_random_uuid()"], ["gen_random_uuid()"])))),
    hostId: varchar("host_id")
        .notNull()
        .references(function () { return hosts.id; }, { onDelete: "cascade" }),
    truckId: varchar("truck_id")
    ...
    userId: varchar("user_id")
        .notNull()
        .references(function () { return users.id; }, { onDelete: "cascade" }), // Food truck owner
    rating: integer("rating").notNull(), // 1-5 stars
    comment: text("comment"),
...
export var eventBookings = pgTable("event_bookings", {
    id: varchar("id")
        .primaryKey()
        .default(sql(templateObject_59 || (templateObject_59 = __makeTemplateObject(["gen_random_uuid()"], ["gen_random_uuid()"])))),
    eventId: varchar("event_id")
        .notNull()
        .references(function () { return events.id; }, { onDelete: "cascade" }),
    truckId: varchar("truck_id")
...
export var truckManualSchedules = pgTable("truck_manual_schedules", {
    id: varchar("id")
        .primaryKey()
        .default(sql(templateObject_60 || (templateObject_60 = __makeTemplateObject(["gen_random_uuid()"], ["gen_random_uuid()"])))),
    truckId: varchar("truck_id")
        .notNull()
        .references(function () { return restaurants.id; }, { onDelete: "cascade" }),
    date: timestamp("date").notNull(),
...
export var referrals = pgTable("referrals", {
    id: varchar("id")
        .primaryKey()
        .default(sql(templateObject_61 || (templateObject_61 = __makeTemplateObject(["gen_random_uuid()"], ["gen_random_uuid()"])))),
    affiliateUserId: varchar("affiliate_user_id")
        .notNull()
        .references(function () { return users.id; }, { onDelete: "cascade" }),
    referredRestaurantId: varchar("referred_restaurant_id").references(function () { return restaurants.id; }, { onDelete: "set null" }),
...
export var referralClicks = pgTable("referral_clicks", {
    id: varchar("id")
        .primaryKey()
        .default(sql(templateObject_62 || (templateObject_62 = __makeTemplateObject(["gen_random_uuid()"], ["gen_random_uuid()"])))),
    affiliateUserId: varchar("affiliate_user_id")
        .notNull()
        .references(function () { return users.id; }, { onDelete: "cascade" }),
...
export var affiliateCommissionLedger = pgTable("affiliate_commission_ledger", {
    id: varchar("id")
        .primaryKey()
        .default(sql(templateObject_63 || (templateObject_63 = __makeTemplateObject(["gen_random_uuid()"], ["gen_random_uuid()"])))),
    affiliateUserId: varchar("affiliate_user_id")
        .notNull()
        .references(function () { return users.id; }, { onDelete: "cascade" }),
    referralId: varchar("referral_id").references(function () { return referrals.id; }, {
        onDelete: "set null",
    }),
    restaurantId: varchar("restaurant_id").references(function () { return restaurants.id; }, {
        onDelete: "set null",
...
export var creditLedger = pgTable("credit_ledger", {
    id: varchar("id")
        .primaryKey()
        .default(sql(templateObject_64 || (templateObject_64 = __makeTemplateObject(["gen_random_uuid()"], ["gen_random_uuid()"])))),
    userId: varchar("user_id")
        .notNull()
        .references(function () { return users.id; }, { onDelete: "cascade" }),
...
export var userPayoutPreferences = pgTable("user_payout_preferences", {
    id: varchar("id")
        .primaryKey()
        .default(sql(templateObject_65 || (templateObject_65 = __makeTemplateObject(["gen_random_uuid()"], ["gen_random_uuid()"])))),
    userId: varchar("user_id")
        .notNull()
        .unique()
        .references(function () { return users.id; }, { onDelete: "cascade" }),
    ...
    createdAt: timestamp("created_at").defaultNow(),
    updatedAt: timestamp("updated_at").defaultNow(),
}, function (table) { return [index("idx_payout_prefs_user").on(table.userId)]; });
// PHASE R1: Restaurant credit redemptions - tracks when users spend credits at restaurants
export var restaurantCreditRedemptions = pgTable("restaurant_credit_redemptions", {
    id: varchar("id")
        .primaryKey()
        .default(sql(templateObject_66 || (templateObject_66 = __makeTemplateObject(["gen_random_uuid()"], ["gen_random_uuid()"])))),
    restaurantId: varchar("restaurant_id")
        .notNull()
        .references(function () { return restaurants.id; }, { onDelete: "cascade" }),
    userId: varchar("user_id")
...
export var restaurantSettlementBatch = pgTable("restaurant_settlement_batch", {
    id: varchar("id")
        .primaryKey()
        .default(sql(templateObject_67 || (templateObject_67 = __makeTemplateObject(["gen_random_uuid()"], ["gen_random_uuid()"])))),
...
export var restaurantSubmissions = pgTable("restaurant_submissions", {
    id: varchar("id")
        .primaryKey()
        .default(sql(templateObject_68 || (templateObject_68 = __makeTemplateObject(["gen_random_uuid()"], ["gen_random_uuid()"])))),
    submittedByUserId: varchar("submitted_by_user_id").references(function () { return users.id; }, { onDelete: "set null" }),
    ...
    approvedAt: timestamp("approved_at"),
    convertedToRestaurantId: varchar("converted_to_restaurant_id").references(function () { return restaurants.id; }, { onDelete: "set null" }),
    createdAt: timestamp("created_at").defaultNow(),
}, function (table) { return [
...
export var awardHistory = pgTable("award_history", {
    id: varchar("id")
        .primaryKey()
        .default(sql(templateObject_69 || (templateObject_69 = __makeTemplateObject(["gen_random_uuid()"], ["gen_random_uuid()"])))),
...
export var imageUploads = pgTable("image_uploads", {
    id: varchar("id")
        .primaryKey()
        .default(sql(templateObject_70 || (templateObject_70 = __makeTemplateObject(["gen_random_uuid()"], ["gen_random_uuid()"])))),
...
export var featuredVideoSlots = pgTable("featured_video_slots", {
    id: varchar("id")
        .primaryKey()
        .default(sql(templateObject_71 || (templateObject_71 = __makeTemplateObject(["gen_random_uuid()"], ["gen_random_uuid()"])))),
    restaurantId: varchar("restaurant_id")
        .notNull()
        .references(function () { return restaurants.id; }, { onDelete: "cascade" }),
    slotNumber: integer("slot_number").notNull(), // 1, 2, or 3
    currentVideoId: varchar("current_video_id").references(function () { return videoStories.id; }, { onDelete: "set null" }),
    cycleStartDate: timestamp("cycle_start_date").defaultNow(),
    cycleEndDate: timestamp("cycle_end_date").default(sql(templateObject_72 || (templateObject_72 = __makeTemplateObject(["NOW() + INTERVAL '1 day'"], ["NOW() + INTERVAL '1 day'"])))), // 24hr rotation
...
export var restaurantSubscriptions = pgTable("restaurant_subscriptions", {
    id: varchar("id")
        .primaryKey()
        .default(sql(templateObject_73 || (templateObject_73 = __makeTemplateObject(["gen_random_uuid()"], ["gen_random_uuid()"])))),
    restaurantId: varchar("restaurant_id")
        .notNull()
        .references(function () { return restaurants.id; }, { onDelete: "cascade" }),
...
export var incidentsRelations = relations(incidents, function (_a) {
    var one = _a.one;
    return ({
        user: one(users, {
...
export var oncallRotationRelations = relations(oncallRotation, function (_a) {
    var one = _a.one;
    return ({
        user: one(users, {
...
export var securityAuditLogRelations = relations(securityAuditLog, function (_a) {
    var one = _a.one;
    return ({
        user: one(users, {
...
export var supportTicketsRelations = relations(supportTickets, function (_a) {
    var one = _a.one;
    return ({
        user: one(users, {
...
export var moderationEventsRelations = relations(moderationEvents, function (_a) {
    var one = _a.one;
    return ({
...
export var affiliateLinksRelations = relations(affiliateLinks, function (_a) {
    var one = _a.one, many = _a.many;
    return ({
...
export var affiliateClicksRelations = relations(affiliateClicks, function (_a) {
    var one = _a.one;
    return ({
...
export var affiliateCommissionsRelations = relations(affiliateCommissions, function (_a) {
    var one = _a.one;
    return ({
        affiliateUser: one(users, {
...
export var affiliateWalletRelations = relations(affiliateWallet, function (_a) {
    var one = _a.one;
    return ({
        user: one(users, {
...
export var affiliateWithdrawalsRelations = relations(affiliateWithdrawals, function (_a) {
    var one = _a.one;
    return ({
        user: one(users, {
...
export var locationRequestsRelations = relations(locationRequests, function (_a) {
    var one = _a.one, many = _a.many;
    return ({
        postedBy: one(users, {
...
export var truckInterestsRelations = relations(truckInterests, function (_a) {
    var one = _a.one;
    return ({
...
export var hostsRelations = relations(hosts, function (_a) {
    var one = _a.one, many = _a.many;
    return ({
        user: one(users, {
            fields: [hosts.userId],
...
export var eventInterestsRelations = relations(eventInterests, function (_a) {
    var one = _a.one;
    return ({
        event: one(events, {
...
export var eventsRelations = relations(events, function (_a) {
    var one = _a.one, many = _a.many;
    return ({
        host: one(hosts, {
...
export var parkingPassBlackoutDatesRelations = relations(parkingPassBlackoutDates, function (_a) {
    var one = _a.one;
    return ({
        series: one(eventSeries, {
...
export var hostReviewsRelations = relations(hostReviews, function (_a) {
    var one = _a.one;
    return ({
        host: one(hosts, {
...
export var eventBookingsRelations = relations(eventBookings, function (_a) {
    var one = _a.one;
    return ({
        event: one(events, {
...
export var truckManualSchedulesRelations = relations(truckManualSchedules, function (_a) {
    var one = _a.one;
    return ({
        truck: one(restaurants, {
...
export var referralsRelations = relations(referrals, function (_a) {
    var one = _a.one;
    return ({
        affiliateUser: one(users, {
...
export var referralClicksRelations = relations(referralClicks, function (_a) {
    var one = _a.one;
    return ({
        affiliateUser: one(users, {
...
export var restaurantSubmissionsRelations = relations(restaurantSubmissions, function (_a) {
    var one = _a.one;
    return ({
...
export var affiliateCommissionLedgerRelations = relations(affiliateCommissionLedger, function (_a) {
    var one = _a.one;
    return ({
        affiliateUser: one(users, {
...
export var creditLedgerRelations = relations(creditLedger, function (_a) {
    var one = _a.one;
    return ({
        user: one(users, {
...
export var userPayoutPreferencesRelations = relations(userPayoutPreferences, function (_a) {
    var one = _a.one;
    return ({
        user: one(users, {
...
export var restaurantCreditRedemptionsRelations = relations(restaurantCreditRedemptions, function (_a) {
    var one = _a.one;
    return ({
        restaurant: one(restaurants, {
...
export var insertLocationRequestSchema = createInsertSchema(locationRequests, {
    ...
    var _a;
    var dates = (_a = val.preferredDates) !== null && _a !== void 0 ? _a : [];
    if (dates.length === 0) {
        ctx.addIssue({
...
export var insertTruckInterestSchema = createInsertSchema(truckInterests, {
    message: z.string().max(500).optional(),
}).omit({
    id: true,
    createdAt: true,
});
export var insertSupportTicketSchema = createInsertSchema(supportTickets).omit({
    id: true,
    createdAt: true,
    updatedAt: true,
    resolvedAt: true,
...
export var insertModerationEventSchema = createInsertSchema(moderationEvents).omit({
    id: true,
    createdAt: true,
    reviewedAt: true,
...
export var insertAffiliateLinkSchema = createInsertSchema(affiliateLinks).omit({
    id: true,
    code: true,
    clickCount: true,
    conversions: true,
...
export var insertRestaurantSubmissionSchema = createInsertSchema(restaurantSubmissions).omit({
    id: true,
    approvedAt: true,
...
export var insertAwardHistorySchema = createInsertSchema(awardHistory).omit({
    id: true,
    awardedAt: true,
});
// Schemas for image uploads
export var insertImageUploadSchema = createInsertSchema(imageUploads).omit({
    id: true,
    uploadedAt: true,
});
// Schemas for featured video slots
export var insertFeaturedVideoSlotSchema = createInsertSchema(featuredVideoSlots).omit({
    id: true,
    cycleStartDate: true,
    updatedAt: true,
});
// Schemas for restaurant subscriptions
export var insertRestaurantSubscriptionSchema = createInsertSchema(restaurantSubscriptions).omit({
    id: true,
    createdAt: true,
    updatedAt: true,
...
export var insertVideoStoryReportSchema = createInsertSchema(videoStoryReports).omit({
    id: true,
    createdAt: true,
    status: true,
    reviewedByAdminId: true,
...
export var insertFeedAdSchema = createInsertSchema(feedAds).omit({
    id: true,
    createdAt: true,
    updatedAt: true,
});
// Schemas for geo ads
export var insertGeoAdSchema = createInsertSchema(geoAds).omit({
    id: true,
    createdAt: true,
    updatedAt: true,
});
export var insertGeoAdEventSchema = createInsertSchema(geoAdEvents).omit({
    id: true,
    createdAt: true,
});
export var insertGeoLocationPingSchema = createInsertSchema(geoLocationPings).omit({
    id: true,
    createdAt: true,
});
export var insertHostSchema = createInsertSchema(hosts)
    .omit({
    id: true,
    createdAt: true,
    updatedAt: true,
...
export var insertParkingPassBlackoutDateSchema = createInsertSchema(parkingPassBlackoutDates).omit({
    id: true,
    createdAt: true,
});
export var insertEventSeriesSchema = createInsertSchema(eventSeries).omit({
    id: true,
    createdAt: true,
    updatedAt: true,
    status: true,
...
export var insertEventSchema = createInsertSchema(events).omit({
    id: true,
    createdAt: true,
    updatedAt: true,
    status: true,
...
export var insertEventInterestSchema = createInsertSchema(eventInterests).omit({
    id: true,
    createdAt: true,
});
export var insertHostReviewSchema = createInsertSchema(hostReviews).omit({
    id: true,
    createdAt: true,
    updatedAt: true,
});
export var insertEventBookingSchema = createInsertSchema(eventBookings).omit({
    id: true,
    createdAt: true,
    updatedAt: true,
    paidAt: true,
...
export var insertTruckManualScheduleSchema = createInsertSchema(truckManualSchedules).omit({
    id: true,
    createdAt: true,
    updatedAt: true,
});
export var insertEmailVerificationTokenSchema = createInsertSchema(emailVerificationTokens).omit({
    id: true,
    createdAt: true,
});
// Telemetry: Generic event tracking for analytics
export var telemetryEvents = pgTable("telemetry_events", {
    id: varchar("id")
        .primaryKey()
        .default(sql(templateObject_74 || (templateObject_74 = __makeTemplateObject(["gen_random_uuid()"], ["gen_random_uuid()"])))),
...
export var lisaClaims = pgTable("lisa_claim", {
    id: varchar("id")
        .primaryKey()
        .default(sql(templateObject_75 || (templateObject_75 = __makeTemplateObject(["gen_random_uuid()"], ["gen_random_uuid()"])))),
...
export var claims = pgTable("claims", {
    id: varchar("id")
        .primaryKey()
        .default(sql(templateObject_76 || (templateObject_76 = __makeTemplateObject(["gen_random_uuid()"], ["gen_random_uuid()"])))),
    ...
    hostId: varchar("host_id").references(function () { return hosts.id; }, {
        onDelete: "set null",
    }),
    eventId: varchar("event_id").references(function () { return events.id; }, {
        onDelete: "set null",
    }),
    ...
    verifiedBy: varchar("verified_by").references(function () { return users.id; }),
    ...
    index("idx_claims_person_type_status").on(table.personId, table.claimType, table.status),
]; });
// Claim type constants
export var CLAIM_TYPES = {
