...
import { Mail, MapPin, HelpCircle, Users, Building, Clock } from "lucide-react";
export default function Contact() {
    ...
    var supportEmail = "info.mealscout@gmail.com";
    var quickHelp = [
    ...
    return (<div className="min-h-screen bg-gradient-to-br from-purple-50 via-pink-50 to-red-50">
      <SEOHead title="Contact MealScout - Email Support" description="Email MealScout support for help with accounts, parking passes, events, restaurants, bars, and food trucks." keywords="mealscout contact, email support, parking pass help, food truck support, host support" canonicalUrl="https://mealscout.us/contact" schemaData={schemaData}/>
      
      <BackHeader title="Contact Us" fallbackHref="/" icon={Mail} className="bg-white/95 backdrop-blur-sm border-b border-gray-200/50 shadow-sm"/>
      ...
      <div className="px-4 py-8 max-w-6xl mx-auto">
        ...
        <div className="grid lg:grid-cols-3 gap-8 mb-16">
          {contactMethods.map(function (method, index) {
            ...
            return (<Card key={index} className="p-6 bg-white/90 backdrop-blur-sm shadow-xl hover:shadow-2xl transition-shadow">
                <CardContent className="p-0 text-center">
                  <div className={"w-16 h-16 ".concat(method.color, " rounded-2xl flex items-center justify-center mx-auto mb-6")}>
                  ...
                  <Button className="w-full bg-gradient-to-r from-purple-500 to-pink-500 hover:from-purple-600 hover:to-pink-600 text-white" onClick={function () {
                    window.location.href = "mailto:".concat(supportEmail, "?subject=").concat(encodeURIComponent(method.title));
                }}>
            ...
            <Card className="bg-white/90 backdrop-blur-sm shadow-xl">
              ...
              <CardContent>
                <div className="space-y-3">
                  {quickHelp.map(function (topic, index) { return (<button key={index} className="w-full text-left p-3 rounded-lg bg-gray-50 hover:bg-blue-50 hover:text-blue-600 transition-colors text-sm" data-testid={"button-quick-help-".concat(index)}>
                      {topic}
                    </button>); })}
                </div>
              </CardContent>
