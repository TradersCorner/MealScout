import { Truck, Radar, Calendar, MapPin, Bolt, Sparkles, Store, Building2, PartyPopper, Users, Utensils, } from "lucide-react";
export var roleLandingContent = {
    truck: {
        seo: {
        ...
        subhead: "MealScout puts your truck on the map hosts actually use. Your profile, schedule, and booking flow are built for how you really move.",
    ...
    restaurants: {
        seo: {
            ...
            description: "Bring locals to your restaurant with a profile built for discovery, specials, and repeat visits.",
        ...
        subhead: "Turn your profile into a mini website, publish specials, and stay visible in local search without extra noise.",
    ...
    bars: {
        seo: {
            ...
            description: "Get discovered locally, publish specials, and stay visible to the people who actually live nearby.",
        ...
        subhead: "Your bar deserves more than random social reach. Use MealScout to stay visible where locals are looking.",
    ...
    diners: {
        seo: {
            ...
            description: "Discover local restaurants, bars, and food trucks with specials and recommendations from your community.",
        ...
        subhead: "Discover food trucks, restaurants, and bars nearby—built by locals, updated by locals.",
    ...
    hosts: {
        seo: {
            ...
            description: "List parking pass locations by address and make it easy for food trucks to book your spots.",
        ...
        subhead: "Add a location once, control your slots, and let trucks book with clarity.",
    ...
    events: {
        seo: {
            ...
            description: "Create and manage events built for food trucks and local hosts. Keep the flow clean and coordinated.",
        ...
        subhead: "Own the event flow, keep trucks informed, and stay organized with one dashboard.",
